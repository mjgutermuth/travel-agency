...
// The specific photo a client saw and pinned, carried alongside the
// destination so the vision board preview shows the same image (not a
// re-randomized one) and can still credit the photographer.
