...
export const vibes: Vibe[] = [
  ...
  { id: "wellness", name: "Wellness & Spa", icon: "Flower2", category: "style", color: "bg-teal-100 text-teal-600 border-teal-200" },
  ...
  { id: "cruise", name: "Cruise", icon: "Ship", category: "activity", color: "bg-sky-100 text-sky-600 border-sky-200" },
  ...
  { id: "water-sports", name: "Sports", icon: "Dumbbell", category: "activity", color: "bg-blue-100 text-blue-600 border-blue-200" },
  ...
  { id: "all-inclusive", name: "Luxury & All-Inclusive", icon: "Crown", category: "accommodation", color: "bg-amber-100 text-amber-600 border-amber-200" },
